...
const messages = {
    ...
    Norsk: {
        message: {
            data_level_5: 'Bodde her',
            data_level_4: 'Overnattet her',
            data_level_3: 'Besøkte her',
            data_level_2: 'Stoppet her',
            data_level_1: 'Dro gjennom her',
            data_level_0_alt: 'Har lyst å dra hit',
            data_level_0: 'Aldri vært her',
            pt: 'poeng | poeng',
        },
        country_name: {
            Agder: 'Agder',
...
const 计分 = _=>{
    ...
    Total.innerHTML = `Norge Level ${分}`;
    webtitle.innerHTML = `Norge Level ${分}`;
}
添加事件监控(设置等级,'click',e=>{
    e.stopPropagation();
